...
class Team:
    ...
    geographical_zone: Optional[GeographicalZone] = None
    ...
    def from_dict(obj: Any) -> "Team":
        ...
        geographical_zone = from_union([extract_geographical_zone, from_none], name)
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        return (
            ...
            and self.geographical_zone == other.geographical_zone
    ...
    def __str__(self) -> str:
        return (
            ...
            f"{self.geographical_zone.value if self.geographical_zone else ''} "
